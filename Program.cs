...
namespace Program
{
    internal class Program
    {
        ...
        {
            Char RickGrimes = new Char(1025, "Rick Grimes", "Revolver", 45, "Leader", true);
            RickGrimes.Intro();

            Char DarylDixon = new Char(987, "Daryl Dixon", "Crossbow", 30, "Hunter", true);
            DarylDixon.Intro();

            Char GlennRhee = new Char(752, "Glenn Rhee", "Butterfly Knife", 25, "Scout", true);
            GlennRhee.Intro();
        }
    }
